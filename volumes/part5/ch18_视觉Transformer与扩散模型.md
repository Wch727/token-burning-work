...
### 6.7.2 反向去噪过程：Score Matching与DDPM
...
### 6.7.4 条件生成：Classifier Guidance与Classifier-Free Guidance
...
### 6.7.5 Score Matching与随机微分方程（SDE）视角
...
### 6.8.4 Google Imagen：级联扩散与T5语言理解
...
### 6.11.2 Fréchet Inception Distance（FID）
...
### 6.11.4 Sliced Fréchet Inception Distance（sFID）
...
### 6.11.6 生成模型的系统比较：扩散模型、GAN与自回归模型
