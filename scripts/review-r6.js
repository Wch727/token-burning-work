export const meta = {
  name: 'review-round-6',
  description: 'Round 6: Re-review ch01-04, ch09-12, ch21-24 that failed in R5',
  phases: [
    { title: 'R6-part1', detail: 'ch01-04 (R5-R1 failed)' },
    { title: 'R6-part3', detail: 'ch09-12 (R5-R3 failed)' },
    { title: 'R6-part6', detail: 'ch21-24 (R5-R6 failed)' },
  ],
}
...
const REVIEWERS = [
  { label: 'R6-R1-part1', chapters: ['ch01','ch02','ch03','ch04'] },
  { label: 'R6-R3-part3', chapters: ['ch09','ch10','ch11','ch12'] },
  { label: 'R6-R6-part6', chapters: ['ch21','ch22','ch23','ch24'] },
]
