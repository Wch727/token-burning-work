export const meta = {
  name: 'review-round-1',
  description: 'Round 1: 6 parallel reviewers for 24 chapters',
  phases: [
    { title: 'R1-part1', detail: 'ch01-04' },
    { title: 'R2-part2', detail: 'ch05-08' },
    { title: 'R3-part3', detail: 'ch09-12' },
    { title: 'R4-part4', detail: 'ch13-16' },
    { title: 'R5-part5', detail: 'ch17-20' },
    { title: 'R6-part6', detail: 'ch21-24' },
  ],
}
...
const REVIEWERS = [
  { label: 'R1-part1', chapters: ['ch01','ch02','ch03','ch04'] },
  { label: 'R2-part2', chapters: ['ch05','ch06','ch07','ch08'] },
  { label: 'R3-part3', chapters: ['ch09','ch10','ch11','ch12'] },
  { label: 'R4-part4', chapters: ['ch13','ch14','ch15','ch16'] },
  { label: 'R5-part5', chapters: ['ch17','ch18','ch19','ch20'] },
  { label: 'R6-part6', chapters: ['ch21','ch22','ch23','ch24'] },
]
