...
Codex在HumanEval上达到28.8%的pass@1和71.2%的pass@100。相比之下，Codex 论文主表中未做代码微调的 **GPT-J 6B** 约 **11.6%** pass@1（不宜写成 GPT-3 = 11.4%）。值得注意的是，Codex在涉及库使用的任务（如使用numpy、pytorch）上表现显著优于纯算法任务，这是因为训练数据中包含了大量使用这些库的实际代码。
