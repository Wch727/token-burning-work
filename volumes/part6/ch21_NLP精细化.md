...
### 6.1.4 FlashAttention：硬件感知的IO优化
...
### 6.2.1 Chain-of-Thought：分步推理的 prompting 范式
...
### 6.2.2 Tree-of-Thought：树状推理与系统化探索
...
### 6.2.3 Graph-of-Thought：图状推理与思维组合
...
### 6.3.1 OpenAI Codex：代码生成的GPT-3微调
...
### 6.3.3 StarCoder与BigCode：开放源代码大模型
...
### 6.4.3 XLM-R：基于RoBERTa的大规模多语言预训练
...
### 6.4.5 PaLM： Pathways架构与大规模多语言统一模型
...
### 6.7.1 GLUE与SuperGLUE：通用语言理解的基准化
