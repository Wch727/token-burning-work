export const meta = {
  name: 'review-round-3',
  description: 'Round 3: Re-review all 24 chapters to verify R2 fixes and find remaining issues',
  phases: [
    { title: 'R3-part1', detail: 'ch01-04' },
    { title: 'R3-part2', detail: 'ch05-08' },
    { title: 'R3-part3', detail: 'ch09-12' },
    { title: 'R3-part4', detail: 'ch13-16' },
    { title: 'R3-part5', detail: 'ch17-20' },
    { title: 'R3-part6', detail: 'ch21-24' },
  ],
}
...
const REVIEWERS = [
  { label: 'R3-R1-part1', chapters: ['ch01','ch02','ch03','ch04'] },
  { label: 'R3-R2-part2', chapters: ['ch05','ch06','ch07','ch08'] },
  { label: 'R3-R3-part3', chapters: ['ch09','ch10','ch11','ch12'] },
  { label: 'R3-R4-part4', chapters: ['ch13','ch14','ch15','ch16'] },
  { label: 'R3-R5-part5', chapters: ['ch17','ch18','ch19','ch20'] },
  { label: 'R3-R6-part6', chapters: ['ch21','ch22','ch23','ch24'] },
]
...
- ch01: UTM公式LaTeX, exhaustive→穷举, E[Pe(P)] cleanup, uttered→说出, retroactive→追溯性
- ch02: 缺主语补充, Parallel Distributed Processing→并行分布式处理, irony→讽刺, automata→自动机, receptive field→感受野
- ch03: 量词(一→一个), trained→受过训练的, 感应层→视网膜, recognize-act→识别-执行, firing→发放, uniformly→完全
- ch04: boating→划船, recognize-act→识别-执行
- ch05:  VC维已修正, Hoffman(2010)→Hoffman(2013)
- ch06: MCMC→马尔可夫链蒙特卡洛, DTM重复内容已删除
- ch07: phi'括号缺失, left(→right)括号匹配
- ch09: Boltzmann引用(Hinton/Sejnowski 1983→Ackley/Hinton/Sejnowski 1985), 重复4.5节已删除
- ch10: GK110 CUDA核心(1920→2880), SM→SMX
- ch12: HOG单元格(8×16→8×8), Dalal-Trigks→Dalal和Triggs
- ch14 VGG感受野(260→114), GoogLeNet(4a→4d)
- ch15 Transformer big模型头数(8→16), 节编号(6.6→第1节等)
- ch16 InfoGAN公式(-H(c)→+H(c))
- ch17 FFN公式(ReLU→GELU), Scaling Laws, C4数据, sparked→集群, GPT-4 MoE参数, RLHF公式括号
- ch18 所有节/子节编号已转为"第X节"格式, 重复子节已删除, 交叉引用已修正
- ch19 所有节/子节编号已转为"第X节"格式, NOTEA→NOTEARS, 交叉引用已修正
- ch20 节编号已修正, Decision Transformer年份, DQN归属, RLHF公式括号
- ch21 Linformer维度, Katharopoulos et al.→Katharopoulos等人
- ch22 Mosaic数据增强归属(YOLOv4→YOLOv5), DeepLabv3年份
- ch23 章节编号, et al.引用
- ch24 LaTeX命令(partial, gg, neq, text, frac, hat, eta, sim, 数学环境包裹)
