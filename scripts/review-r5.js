export const meta = {
  name: 'review-round-5',
  description: 'Round 5: Re-review all 24 chapters to verify R4 fixes and find remaining issues',
  phases: [
    { title: 'R5-part1', detail: 'ch01-04' },
    { title: 'R5-part2', detail: 'ch05-08' },
    { title: 'R5-part3', detail: 'ch09-12' },
    { title: 'R5-part4', detail: 'ch13-16' },
    { title: 'R5-part5', detail: 'ch17-20' },
    { title: 'R5-part6', detail: 'ch21-24' },
  ],
}
...
const REVIEWERS = [
  { label: 'R5-R1-part1', chapters: ['ch01','ch02','ch03','ch04'] },
  { label: 'R5-R2-part2', chapters: ['ch05','ch06','ch07','ch08'] },
  { label: 'R5-R3-part3', chapters: ['ch09','ch10','ch11','ch12'] },
  { label: 'R5-R4-part4', chapters: ['ch13','ch14','ch15','ch16'] },
  { label: 'R5-R5-part5', chapters: ['ch17','ch18','ch19','ch20'] },
  { label: 'R5-R6-part6', chapters: ['ch21','ch22','ch23','ch24'] },
]
...
- ch01: UTM公式LaTeX, exhaustive→穷举, E[Pe(P)] cleanup, uttered→说出, retroactive→追溯性, 二进制1100
- ch02: 缺主语补充, Parallel Distributed Processing→并行分布式处理, irony→讽刺, automata→自动机, receptive field→感受野, Novikoff（1962）引用格式, VC引用格式
- ch03: 量词(一→一个), trained→受过训练的, 感应层→视网膜, recognize-act→识别-执行, firing→发放, uniformly→完全
- ch04: boating→划船, recognize-act→识别-执行, 节编号已转为阿拉伯数字(第1节等), MYCIN公式LaTeX cases环境, 交叉引用已修正
...
- ch22 Mosaic数据增强归属(YOLOv4→YOLOv5), DeepLabv3年份, SSD特征图尺寸(10×10/5×5/3×3/1×1)
- ch23 章节编号, et al.引用
